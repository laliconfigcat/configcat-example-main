...
const configCatClient = configcat.getClient('configcat-sdk-1/tP3YCDSlzUeMVb36fHm4Fw/MehpaJ_x1UakimZRkRlvsA', configcat.PollingMode.AutoPoll, {logger: configcat.createConsoleLogger(configcat.LogLevel.Debug)});
